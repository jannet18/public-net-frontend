      ...
      <div className="sm:flex sm:items-center sm:justify-between">
        <div>
          <div className="flex flex-col justify-start items-center gap-x-3">
            <h2 className="text-lg uppercase font-medium  dark:text-gray-800">
              Public Internet Speed Checker
            </h2>

            <p className="mt-1 text-sm text-gray-500 dark:text-gray-300">
              These places have been tested in the last 12 months.
              <span className="px-3 py-1 text-xs text-blue-600 bg-blue-100 rounded-full dark:bg-gray-800 dark:text-blue-400 ml-4">
                240 Locations
              </span>
            </p>
          </div>
                ...
                <thead className="bg-gray-50 dark:bg-gray-800">
                  <tr>
                    ...
                    <th
                      ...
                      className="px-4 py-3.5 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400"
                    >
                      Most Recent Download Speed
                    </th>
                    <th
                      scope="col"
                      className="px-4 py-3.5 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400"
                    >
                      Most Recent Download Units
                    </th>
                    <th
                      scope="col"
                      className="px-4 py-3.5 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400"
                    >
                      Number of Speed Tests
                    </th>
                  </tr>
                </thead>
                <tbody className="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900 text-gray-500">
